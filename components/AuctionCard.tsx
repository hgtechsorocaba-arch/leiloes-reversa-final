    ...
    >
      ...
      <div className="p-6 flex flex-col flex-grow space-y-4">
        ...
        <div className="pt-2 flex items-center justify-between">
          ...
          <button className={`p-3 rounded-xl transition-all ${isEnded ? 'bg-slate-100 text-slate-400' : 'bg-indigo-50 text-indigo-600 group-hover:bg-indigo-600 group-hover:text-white'}`}>
